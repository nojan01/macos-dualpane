    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            term: "Kopieren (F5)",
            desc: "Auswahl in den gegenüberliegenden Bereich kopieren.",
          },
          {
            term: "Verschieben (F6)",
            desc: "Auswahl in den gegenüberliegenden Bereich verschieben.",
          },
          {
            term: "Neuer Ordner (F7)",
            desc: "Im aktiven Bereich einen Ordner anlegen.",
          },
          {
            term: "Löschen (F8 / ⌫)",
            desc: "Auswahl in den Papierkorb legen. Mit ⇧ unwiderruflich löschen.",
          },
          {
            term: "Umbenennen (F2)",
            desc: "Datei oder Ordner umbenennen; Stapel-Umbenennung wird unterstützt.",
          },
          {
            term: "Suchen (⌘F)",
            desc: "Im aktuellen Ordner nach Namen filtern.",
          },
          {
            term: "Vorschau (⌘I)",
            desc: "Vorschau-Bereich für die markierte Datei ein-/ausblenden.",
          },
          {
          ...
          },
          {
            ...
            desc: "Netzwerkfreigabe über eine URL einbinden – siehe Netzwerkprotokolle.",
          },
          {
            term: "Neues Fenster (⌘N)",
            desc: "Ein weiteres unabhängiges DualBeam-Fenster öffnen.",
          },
          {
            term: "Seitenleiste (⌘B)",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          {
            term: "Copy (F5)",
            desc: "Copy the selection to the opposite pane.",
          },
          {
            term: "Move (F6)",
            desc: "Move the selection to the opposite pane.",
          },
          {
            term: "New folder (F7)",
            desc: "Create a folder in the active pane.",
          },
          {
            term: "Delete (F8 / ⌫)",
            desc: "Move the selection to the Trash. Hold ⇧ to delete permanently.",
          },
          {
            term: "Rename (F2)",
            desc: "Rename a file or folder; batch renaming is supported.",
          },
          { term: "Search (⌘F)", desc: "Filter the current folder by name." },
          {
            term: "Preview (⌘I)",
            desc: "Show or hide the preview pane for the selected file.",
          },
          {
            term: "Synchronize",
          ...
          },
          {
            ...
            desc: "Mount a network share via a URL – see network protocols.",
          },
          {
            term: "New window (⌘N)",
            desc: "Open another independent DualBeam window.",
          },
          {
            term: "Sidebar (⌘B)",
